...
const SignUp = () => {
  ...
  return (
    <div className="mesh-gradient relative flex min-h-screen w-full flex-col items-center justify-center overflow-auto p-4 sm:p-6 lg:p-8">
      {/* Main Card Container */}
      <div className="glass-card flex w-full max-w-[1000px] flex-col overflow-hidden rounded-xl shadow-2xl lg:flex-row h-auto lg:h-[760px]">
        ...
        <div className="flex w-full flex-col justify-center bg-white/60 px-6 py-8 dark:bg-[#121022]/80 sm:px-12 lg:w-1/2 lg:px-16 h-full overflow-y-auto">
          ...
          <div className="mb-6 text-center lg:text-left">
            <h1 className="font-display text-2xl font-extrabold text-slate-900 dark:text-white md:text-3xl">Create Account</h1>
            <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">Enter your information to get started.</p>
          </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                    ...
                    <FormItem className="space-y-1">
                      ...
                      <FormControl>
                        <Input
                          ...
                          {...field}
                          className="h-10 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm outline-none transition-all placeholder:text-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:placeholder:text-slate-600 dark:focus:border-primary"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input
                            ...
                            {...field}
                            className="h-10 w-full rounded-lg border border-slate-200 bg-white px-3 pr-10 text-sm outline-none transition-all placeholder:text-slate-400 focus:border-primary focus:ring-2 focus:ring-primary/20 dark:border-slate-700 dark:bg-slate-900 dark:text-white dark:placeholder:text-slate-600 dark:focus:border-primary"
                            placeholder="••••••••"
                          />
                          <button
                            type="button"
                ...
                <Button
                  type="submit"
                  disabled={isPending}
                  className="mt-2 flex h-10 w-full items-center justify-center rounded-lg bg-gradient-to-r from-primary to-indigo-600 text-sm font-bold text-white shadow-lg shadow-indigo-500/30 transition-all hover:scale-[1.02] hover:shadow-indigo-500/40 active:scale-[0.98]"
                >
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4 text-sm text-slate-600 dark:text-slate-400 lg:text-white/60">
        ...
        <Link to="/help" className="hover:text-primary lg:hover:text-white transition-colors">Help Center</Link>
      </div>
    </div>
  );
};
